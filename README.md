...
1. OWASP Foundation — OWASP Internet of Things Security Verification Standard (ISVS) — https://github.com/OWASP/IoT-Security-Verification-Standard-ISVS — Truy cập ngày 17/07/2026 — Dùng cho Chương 2, 3 và 6 (Khung tiêu chuẩn xác thực an ninh IoT).
